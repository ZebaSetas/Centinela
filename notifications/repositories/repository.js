...
const GeneralPreferenceModel = require('../models/generalPreference')
...
module.exports = class Repository {
  ...
  static async loadModels() {
    const Preference = PreferenceModel(this.connection, Sequelize)
    const Bug = BugModel(this.connection, Sequelize)
    const GeneralPreference = GeneralPreferenceModel(this.connection
      , Sequelize)

    module.exports.Preference = Preference
    module.exports.GeneralPreference = GeneralPreference
